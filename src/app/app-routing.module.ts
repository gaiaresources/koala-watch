...
export const routes: Routes = [
  ...
  // {path: 'census', component:CensusPage},
  {
    path: 'forgotpassword',
  ...
  {
    path: 'mappinpage',
    loadChildren: () => import('../pages/map-pin-page/map-pin-page.module').then(m => m.MapPinPageModule)
  },
  {
    path: 'observation',
  ...
  {
    path: 'signup-privacy-policy-page',
    loadChildren: () => import('../pages/signup-privacy-policy-page/signup-privacy-policy-page.module').then(m => m.SignupPrivacyPolicyPagePageModule)
  }
];
