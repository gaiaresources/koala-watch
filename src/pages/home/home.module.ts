...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: 'recordslist',
        loadChildren: () => import('../../components/records-list/records-list.module').then(m => m.RecordListModule)
      },
      {
        path: 'recordsmap',
        loadChildren: () => import('../../components/records-map/records-map.module').then(m => m.RecordsMapModule)
      }
    ]
  },
